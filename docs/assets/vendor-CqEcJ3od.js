...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function Ch(i,e,t){const n=new Float32Array(di),r=new G(0,1,0);return new Hn({name:"SphericalGaussianBlur",defines:{n:di,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Xr(),fragmentShader:`
	...
	`}function Ph(i){let e=new WeakMap,t=null;function n(c){if(c&&c.isTexture){const u=c.mapping,l=u===Bs||u===zs,p=u===Fi||u===Oi;if(l||p){let m=e.get(c);const x=m!==void 0?m.texture.pmremVersion:0;if(c.isRenderTargetTexture&&c.pmremVersion!==x)return t===null&&(t=new co(i)),m=l?t.fromEquirectangular(c,m):t.fromCubemap(c,m),m.texture.pmremVersion=c.pmremVersion,e.set(c,m),m.texture;if(m!==void 0)return m.texture;{const _=c.image;return l&&_&&_.height>0||p&&_&&r(_)?(t===null&&(t=new co(i)),m=l?t.fromEquirectangular(c):t.fromCubemap(c),m.texture.pmremVersion=c.pmremVersion,e.set(c,m),c.addEventListener("dispose",s),m.texture):null}}}return c}function r(c){let u=0;const l=6;for(let p=0;p<l;p++)c[p]!==void 0&&u++;return u===l}function s(c){const u=c.target;u.removeEventListener("dispose",s);const l=e.get(u);l!==void 0&&(e.delete(u),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Lh(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&ir("WebGLRenderer: "+n+" extension not supported."),r}}}function Dh(i,e,t,n){const r={},s=new WeakMap;function o(m){const x=m.target;x.index!==null&&e.remove(x.index);for(const S in x.attributes)e.remove(x.attributes[S]);x.removeEventListener("dispose",o),delete r[x.id];const _=s.get(x);_&&(e.remove(_),s.delete(x)),n.releaseStatesOfGeometry(x),x.isInstancedBufferGeometry===!0&&delete x._maxInstanceCount,t.memory.geometries--}function c(m,x){return r[x.id]===!0||(x.addEventListener("dispose",o),r[x.id]=!0,t.memory.geometries++),x}function u(m){const x=m.attributes;for(const _ in x)e.update(x[_],i.ARRAY_BUFFER)}function l(m){const x=[],_=m.index,S=m.attributes.position;let y=0;if(_!==null){const P=_.array;y=_.version;for(let A=0,D=P.length;A<D;A+=3){const U=P[A+0],R=P[A+1],I=P[A+2];x.push(U,R,R,I,I,U)}}else if(S!==void 0){const P=S.array;y=S.version;for(let A=0,D=P.length/3-1;A<D;A+=3){const U=A+0,R=A+1,I=A+2;x.push(U,R,R,I,I,U)}}else return;const g=new(Ho(x)?Ko:jo)(x,1);g.version=y;const d=s.get(m);d&&e.remove(d),s.set(m,g)}function p(m){const x=s.get(m);if(x){const _=m.index;_!==null&&x.version<_.version&&l(m)}else l(m);return s.get(m)}return{get:c,update:u,getWireframeAttribute:p}}function Uh(i,e,t){let n;function r(x){n=x}let s,o;function c(x){s=x.type,o=x.bytesPerElement}function u(x,_){i.drawElements(n,_,s,x*o),t.update(_,n,1)}function l(x,_,S){S!==0&&(i.drawElementsInstanced(n,_,s,x*o,S),t.update(_,n,S))}function p(x,_,S){if(S===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,_,0,s,x,0,S);let g=0;for(let d=0;d<S;d++)g+=_[d];t.update(g,n,1)}function m(x,_,S,y){if(S===0)return;const g=e.get("WEBGL_multi_draw");if(g===null)for(let d=0;d<x.length;d++)l(x[d]/o,_[d],y[d]);else{g.multiDrawElementsInstancedWEBGL(n,_,0,s,x,0,y,0,S);let d=0;for(let P=0;P<S;P++)d+=_[P]*y[P];t.update(d,n,1)}}this.setMode=r,this.setIndex=c,this.render=u,this.renderInstances=l,this.renderMultiDraw=p,this.renderMultiDrawInstances=m}function Ih(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,c){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=c*(s/3);break;case i.LINES:t.lines+=c*(s/2);break;case i.LINE_STRIP:t.lines+=c*(s-1);break;case i.LINE_LOOP:t.lines+=c*s;break;case i.POINTS:t.points+=c*s;break;default:Nt("WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Nh(i,e,t){const n=new WeakMap,r=new wt;function s(o,c,u){const l=o.morphTargetInfluences,p=c.morphAttributes.position||c.morphAttributes.normal||c.morphAttributes.color,m=p!==void 0?p.length:0;let x=n.get(c);if(x===void 0||x.count!==m){let E=function(){I.dispose(),n.delete(c),c.removeEventListener("dispose",E)};x!==void 0&&x.texture.dispose();const _=c.morphAttributes.position!==void 0,S=c.morphAttributes.normal!==void 0,y=c.morphAttributes.color!==void 0,g=c.morphAttributes.position||[],d=c.morphAttributes.normal||[],P=c.morphAttributes.color||[];let A=0;_===!0&&(A=1),S===!0&&(A=2),y===!0&&(A=3);let D=c.attributes.position.count*A,U=1;D>e.maxTextureSize&&(U=Math.ceil(D/e.maxTextureSize),D=e.maxTextureSize);const R=new Float32Array(D*U*4*m),I=new Wo(R,D,U,m);I.type=Vn,I.needsUpdate=!0;const j=A*4;for(let b=0;b<m;b++){const N=g[b],q=d[b],W=P[b],Q=D*U*4*b;for(let ne=0;ne<N.count;ne++){const te=ne*j;_===!0&&(r.fromBufferAttribute(N,ne),R[Q+te+0]=r.x,R[Q+te+1]=r.y,R[Q+te+2]=r.z,R[Q+te+3]=0),S===!0&&(r.fromBufferAttribute(q,ne),R[Q+te+4]=r.x,R[Q+te+5]=r.y,R[Q+te+6]=r.z,R[Q+te+7]=0),y===!0&&(r.fromBufferAttribute(W,ne),R[Q+te+8]=r.x,R[Q+te+9]=r.y,R[Q+te+10]=r.z,R[Q+te+11]=W.itemSize===4?r.w:1)}}x={count:m,texture:I,size:new dt(D,U)},n.set(c,x),c.addEventListener("dispose",E)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)u.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let _=0;for(let y=0;y<l.length;y++)_+=l[y];const S=c.morphTargetsRelative?1:1-_;u.getUniforms().setValue(i,"morphTargetBaseInfluence",S),u.getUniforms().setValue(i,"morphTargetInfluences",l)}u.getUniforms().setValue(i,"morphTargetsTexture",x.texture,t),u.getUniforms().setValue(i,"morphTargetsTextureSize",x.size)}return{update:s}}function Fh(i,e,t,n){let r=new WeakMap;function s(u){const l=n.render.frame,p=u.geometry,m=e.get(u,p);if(r.get(m)!==l&&(e.update(m),r.set(m,l)),u.isInstancedMesh&&(u.hasEventListener("dispose",c)===!1&&u.addEventListener("dispose",c),r.get(u)!==l&&(t.update(u.instanceMatrix,i.ARRAY_BUFFER),u.instanceColor!==null&&t.update(u.instanceColor,i.ARRAY_BUFFER),r.set(u,l))),u.isSkinnedMesh){const x=u.skeleton;r.get(x)!==l&&(x.update(),r.set(x,l))}return m}function o(){r=new WeakMap}function c(u){const l=u.target;l.removeEventListener("dispose",c),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}const ac=new nn,ho=new Qo(1,1),oc=new Wo,cc=new ol,lc=new Jo,po=[],mo=[],xo=new Float32Array(16),go=new Float32Array(9),_o=new Float32Array(4);function ki(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=po[r];if(s===void 0&&(s=new Float32Array(r),po[r]=s),e!==0){n.toArray(s,0);for(let o=1,c=0;o!==e;++o)c+=t,i[o].toArray(s,c)}return s}function zt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Vt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Yr(i,e){let t=mo[e];t===void 0&&(t=new Int32Array(e),mo[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Oh(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Bh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(zt(t,e))return;i.uniform2fv(this.addr,e),Vt(t,e)}}function zh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(zt(t,e))return;i.uniform3fv(this.addr,e),Vt(t,e)}}function Vh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(zt(t,e))return;i.uniform4fv(this.addr,e),Vt(t,e)}}function Gh(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(zt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Vt(t,e)}else{if(zt(t,n))return;_o.set(n),i.uniformMatrix2fv(this.addr,!1,_o),Vt(t,n)}}function kh(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(zt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Vt(t,e)}else{if(zt(t,n))return;go.set(n),i.uniformMatrix3fv(this.addr,!1,go),Vt(t,n)}}function Hh(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(zt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Vt(t,e)}else{if(zt(t,n))return;xo.set(n),i.uniformMatrix4fv(this.addr,!1,xo),Vt(t,n)}}function Wh(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Xh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(zt(t,e))return;i.uniform2iv(this.addr,e),Vt(t,e)}}function Yh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(zt(t,e))return;i.uniform3iv(this.addr,e),Vt(t,e)}}function qh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(zt(t,e))return;i.uniform4iv(this.addr,e),Vt(t,e)}}function jh(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Kh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(zt(t,e))return;i.uniform2uiv(this.addr,e),Vt(t,e)}}function $h(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(zt(t,e))return;i.uniform3uiv(this.addr,e),Vt(t,e)}}function Zh(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(zt(t,e))return;i.uniform4uiv(this.addr,e),Vt(t,e)}}function Jh(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(ho.compareFunction=ko,s=ho):s=ac,t.setTexture2D(e||s,r)}function Qh(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||cc,r)}function ed(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||lc,r)}function td(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||oc,r)}function nd(i){switch(i){case 5126:return Oh;case 35664:return Bh;case 35665:return zh;case 35666:return Vh;case 35674:return Gh;case 35675:return kh;case 35676:return Hh;case 5124:case 35670:return Wh;case 35667:case 35671:return Xh;case 35668:case 35672:return Yh;case 35669:case 35673:return qh;case 5125:return jh;case 36294:return Kh;case 36295:return $h;case 36296:return Zh;case 35678:case 36198:case 36298:case 36306:case 35682:return Jh;case 35679:case 36299:case 36307:return Qh;case 35680:case 36300:case 36308:case 36293:return ed;case 36289:case 36303:case 36311:case 36292:return td}}function id(i,e){i.uniform1fv(this.addr,e)}function rd(i,e){const t=ki(e,this.size,2);i.uniform2fv(this.addr,t)}function sd(i,e){const t=ki(e,this.size,3);i.uniform3fv(this.addr,t)}function ad(i,e){const t=ki(e,this.size,4);i.uniform4fv(this.addr,t)}function od(i,e){const t=ki(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function cd(i,e){const t=ki(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function ld(i,e){const t=ki(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function ud(i,e){i.uniform1iv(this.addr,e)}function fd(i,e){i.uniform2iv(this.addr,e)}function hd(i,e){i.uniform3iv(this.addr,e)}function dd(i,e){i.uniform4iv(this.addr,e)}function pd(i,e){i.uniform1uiv(this.addr,e)}function md(i,e){i.uniform2uiv(this.addr,e)}function xd(i,e){i.uniform3uiv(this.addr,e)}function gd(i,e){i.uniform4uiv(this.addr,e)}function _d(i,e,t){const n=this.cache,r=e.length,s=Yr(t,r);zt(n,s)||(i.uniform1iv(this.addr,s),Vt(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||ac,s[o])}function vd(i,e,t){const n=this.cache,r=e.length,s=Yr(t,r);zt(n,s)||(i.uniform1iv(this.addr,s),Vt(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||cc,s[o])}function Md(i,e,t){const n=this.cache,r=e.length,s=Yr(t,r);zt(n,s)||(i.uniform1iv(this.addr,s),Vt(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||lc,s[o])}function Sd(i,e,t){const n=this.cache,r=e.length,s=Yr(t,r);zt(n,s)||(i.uniform1iv(this.addr,s),Vt(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||oc,s[o])}function bd(i){switch(i){case 5126:return id;case 35664:return rd;case 35665:return sd;case 35666:return ad;case 35674:return od;case 35675:return cd;case 35676:return ld;case 5124:case 35670:return ud;case 35667:case 35671:return fd;case 35668:case 35672:return hd;case 35669:case 35673:return dd;case 5125:return pd;case 36294:return md;case 36295:return xd;case 36296:return gd;case 35678:case 36198:case 36298:case 36306:case 35682:return _d;case 35679:case 36299:case 36307:return vd;case 35680:case 36300:case 36308:case 36293:return Md;case 36289:case 36303:case 36311:case 36292:return Sd}}class yd{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=nd(t.type)}}class Ed{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=bd(t.type)}}class Td{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const c=r[s];c.setValue(e,t[c.id],n)}}}const Rs=/(\w+)(\])?(\[|\.)?/g;function vo(i,e){i.seq.push(e),i.map[e.id]=e}function Ad(i,e,t){const n=i.name,r=n.length;for(Rs.lastIndex=0;;){const s=Rs.exec(n),o=Rs.lastIndex;let c=s[1];const u=s[2]==="]",l=s[3];if(u&&(c=c|0),l===void 0||l==="["&&o+2===r){vo(t,l===void 0?new yd(c,i,e):new Ed(c,i,e));break}else{let m=t.map[c];m===void 0&&(m=new Td(c),vo(t,m)),t=m}}}class zr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Ad(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const c=t[s],u=n[c.id];u.needsUpdate!==!1&&c.setValue(e,u.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Mo(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const wd=37297;let Rd=0;function Cd(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const c=o+1;n.push(`${c===e?">":" "} ${c}: ${t[o]}`)}return n.join(`
`)}const So=new Je;function Pd(i){pt._getMatrix(So,pt.workingColorSpace,i);const e=`mat3( ${So.elements.map(t=>t.toFixed(4))} )`;switch(pt.getTransfer(i)){case Vr:return[e,"LinearTransferOETF"];case At:return[e,"sRGBTransferOETF"];default:return $e("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function bo(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const c=parseInt(o[1]);return t.toUpperCase()+`

`+s+`

`+Cd(i.getShaderSource(e),c)}else return s}function Ld(i,e){const t=Pd(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Dd(i,e){let t;switch(e){case Nc:t="Linear";break;case Fc:t="Reinhard";break;case Oc:t="Cineon";break;case Bc:t="ACESFilmic";break;case Vc:t="AgX";break;case Gc:t="Neutral";break;case zc:t="Custom";break;default:$e("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ir=new G;function Ud(){pt.getLuminanceCoefficients(Ir);const i=Ir.x.toFixed(4),e=Ir.y.toFixed(4),t=Ir.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function kd(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Lo?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===pc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===On&&(e="SHADOWMAP_TYPE_VSM"),e}function Hd(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Fi:case Oi:e="ENVMAP_TYPE_CUBE";break;case Hr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Wd(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Oi:e="ENVMAP_MODE_REFRACTION";break}return e}function Xd(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Do:e="ENVMAP_BLENDING_MULTIPLY";break;case Uc:e="ENVMAP_BLENDING_MIX";break;case Ic:e="ENVMAP_BLENDING_ADD";break}return e}function Yd(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function qd(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,c=t.fragmentShader;const u=kd(t),l=Hd(t),p=Wd(t),m=Xd(t),x=Yd(t),_=Id(t),S=Nd(s),y=r.createProgram();let g,d,P=t.glslVersion?"#version "+t.glslVersion+`
